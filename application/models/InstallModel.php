...
class InstallModel extends CI_Model {
	...
	public function finishInstall($data) {
		...
		$main = file_get_contents(FCPATH . 'application/views/install/includes/replace/Main.php');
		file_put_contents(FCPATH . 'application/controllers/Main.php', $main);
	}
