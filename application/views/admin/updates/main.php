				...
				<div class="card-body">
					<div class="row">
                     ...
                     <div class="form-group">
                        <?php if($modules['updates']['status'] == 'available') { ?>
                           ...
                           <div>
                              ...
                              <ul>
                                 ...
                                 <li>Upload the <code>upload.zip</code> & <code>update.json</code> files using FTP into the <code><?php echo APPPATH.'third_party/update/' ?></code> Directory.</li>
                                 <li>After the upload, Press the "Update Now" button below.</li>
                              </ul>
                           </div>
                           <a id="update-btn" href="#" class="btn btn-success mt-1 <?php echo_if(!$modules['updates']['uploaded'], 'disabled') ?>"><i class="fas fa-check mr-1"></i> Update Now</a>
