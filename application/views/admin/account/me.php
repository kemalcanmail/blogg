                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="<?php anchor_to(ACCOUNT_CONTROLLER . '/me') ?>">
                                        <div class="form-group">
                                            ...
                                            <input id="admin-username" name="admin-username" placeholder="Enter your desired Username" value="<?php echo esc($admin['username']) ?>" type="text" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="admin-email" name="admin-email" placeholder="Enter your desired E-Mail" value="<?php echo esc($admin['email']) ?>" type="email" class="form-control">
                                        </div>
                                        <div class="form-group">
